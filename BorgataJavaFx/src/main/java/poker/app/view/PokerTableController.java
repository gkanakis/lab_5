...
public class PokerTableController {
	...
	@FXML
	public Label lblP1Winner;
	@FXML
	public Label lblP2Winner;
	@FXML
	public Label lblP3Winner;
	@FXML
	public Label lblP4Winner;
	...
	@FXML
	private void handleP1Winner() {
		lblP1Winner.setVisible(false);
	}
	@FXML
	private void handleP2Winner() {
		lblP2Winner.setVisible(false);
	}
	@FXML
	private void handleP3Winner() {
		lblP3Winner.setVisible(false);
	}
	@FXML
	private void handleP4Winner() {
		lblP4Winner.setVisible(false);
	}
	...
	private void handleDraw() {
		...
		if (act.isbEvaluateHand()) {
			...
			if (WinningPlayer.getiPlayerPosition() == 1){
				lblP1Winner.setVisible(true);
			}
			else if (WinningPlayer.getiPlayerPosition() == 2){
				lblP2Winner.setVisible(true);
			}
			else if (WinningPlayer.getiPlayerPosition() == 3){
				lblP3Winner.setVisible(true);
			}
			else 
				lblP4Winner.setVisible(true);
